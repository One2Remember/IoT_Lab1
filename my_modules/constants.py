...
global DOWNSIZED_ENV_SIDE_LENGTH, EPSILON
...
ROOM_WIDTH_CM = 270     # approximate width of room in cm
ROOM_HEIGHT_CM = 270    # approximate height of room in cm
...
DOWNSIZED_ENV_SIDE_LENGTH = 30  # the side length of the downsized environment (30x30 square from 300x300)
